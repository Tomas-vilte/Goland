...
//Análisis: para la solución de este problema, se requiere que el usuario ingrese el valor de venta del producto
//y el sistema realice el cálculo respectivo para hallar el IGV y el precio de venta.
